...
(function () {
  ...
  function refreshSubtopicChrome(chapterSlug, subtopicSlug) {
    ...
    if (current) renderNotesPanel(current.topicId, { preferTopic: true });
  }
